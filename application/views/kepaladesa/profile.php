            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href=" href="<?=base_url('kepaladesa')?>"><i class="fas fa-home"></i></a></li> 
        ...
        <div class="col-xl-7 order-xl-1">
          ...
          <div class="card"> 
            <div class="card-body">
              ...
              <form action="<?=base_url('kepaladesa/profile/')?>" method="POST" id="formprofile">
                <div class="pl-lg-4">
                  <div class="row">
...
<div class="modal fade" id="edit-pw" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url('kepaladesa/profile/')?>" method="POST" id="formgpw">
