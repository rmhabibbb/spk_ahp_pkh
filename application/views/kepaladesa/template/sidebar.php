  ...
  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="<?=base_url('kepaladesa')?>">
           <b>SPK - AHP</b>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link <?php if($index == 1){ echo 'active'; } ?>" href="<?=base_url('kepaladesa/')?>">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($index == 7){ echo 'active'; } ?>" href="<?=base_url('kepaladesa/laporan')?>">
          ...
          <ul class="navbar-nav mb-md-3">
             ...
             <li class="nav-item">
              <a class="nav-link <?php if($index == 9){ echo 'active'; } ?>" href="<?=base_url('kepaladesa/profile')?>"  >
